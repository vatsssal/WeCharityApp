...
<html lang="en">
   ...
   <body>
         ...
         <div class="container">
            <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
               <div class="col-md-7 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
                  ...
                  <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Donated</h1>
               </div>
            </div>
         </div>
      </div>
      <section class="ftco-section bg-light">
         <div class="container">
            <center>
               <h3 style="margin-bottom: 40px;">Rupees Donated</h3>
            </center>
            <div class="row">
               <?php
                  include'connect.php';
                  ...
                  $sql=$link->rawQuery("select * from charity INNER JOIN charity_donation ON charity.charity_id=charity_donation.charity_id where charity_donation.user_id='$user_id'");
                  if($link->count>0)
                  {
               ...
               <div class="col-lg-4 d-flex mb-sm-4 ftco-animate">
                  <div class="staff">
                     <div class="d-flex mb-4">
                        ...
                        <div class="info ml-4">
                           <h6><a href="teacher-single.html">Donated On</a></h6>
                           <h3><a href="teacher-single.html"><?=$charity['charity_name'];?></a></h3>
                           <h6><a href="teacher-single.html">Amount Donated: <?=$charity['charity_amount'];?></a></h6>
