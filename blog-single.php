...
<html lang="en">
   ...
   <body>
      ...
      <section class="ftco-section ftco-degree-bg">
         ...
         <div class="container">
            <div class="row">
               <div class="col-md-6 ftco-animate" style="text-align: justify;margin-left: -40px;">
                  <h2><?=$blog['blog_title'];?></h2>
                  <p><?=$blog['blog_content'];?></p>
               </div>
               <div class="col-md-6 ftco-animate">
                  <p>
                     <img src="admin/images/blogs_img/<?=$blog['blog_image'];?>"  style="max-width: 125%;" class="img-fluid">
                  </p>
               </div>
            </div>
         </div>
